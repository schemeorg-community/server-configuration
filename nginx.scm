...
;;   -d chez.scheme.org \
;;   -d chibi.scheme.org \
;;   -d chicken.scheme.org \
;;   -d comm.scheme.org \
;;   -d community.scheme.org \
;;   -d conservatory.scheme.org \
;;   -d cookbook.scheme.org \
;;   -d cyclone.scheme.org \
;;   -d doc.scheme.org \
;;   -d docs.scheme.org \
;;   -d docs.staging.scheme.org \
;;   -d events.scheme.org \
;;   -d faq.scheme.org \
;;   -d files.scheme.org \
;;   -d gauche.scheme.org \
